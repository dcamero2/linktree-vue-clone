<template>
  <a
    ...
    class="relative group flex w-full items-center gap-4 rounded-xl border border-gray-700 bg-gray-800 p-4 shadow-md shadow-gray-900/50 hover:scale-[1.02] hover:border-green-600 hover:shadow-xl transition-all duration-300 hover:shadow-green-500/20"
  >
  <!-- Icon Container -->
    <div
    ...
    <!-- Text Content -->
     ...
     <!-- Hover Glow Effect -->
      <div class="absolute inset-0 rounded-xl bg-linear-to-r from-green-500/0 via-green-500/10 to-green-500/0 opacity-0 transition-opacity duration-300 group-hover:opacity-100"/>
  </a>
</template>
